...
function init()
  ...
  -- Elite System (game_elite): chamas por tier. Reusa o vertex de outfit padrao
  -- (fornece v_TexCoord) + frag custom em /data/shaders/fragment. Aplicados via
  -- creature:setShader('Outfit - Flame ...') no mod game_elite.
  g_shaders.createOutfitShader("Outfit - Flame Green", "/shaders/outfit_default_vertex", "/shaders/fragment/flame_green")
  g_shaders.setupOutfitShader("Outfit - Flame Green")
  g_shaders.createOutfitShader("Outfit - Flame Wine", "/shaders/outfit_default_vertex", "/shaders/fragment/flame_wine")
  g_shaders.setupOutfitShader("Outfit - Flame Wine")
  g_shaders.createOutfitShader("Outfit - Flame BlackRed", "/shaders/outfit_default_vertex", "/shaders/fragment/flame_blackred")
  g_shaders.setupOutfitShader("Outfit - Flame BlackRed")
