...
function getFramePosition(id, frameWidth, frameHeight, fpr)
  ...
  -- Pula a 1a linha do strip (frames 0..fpr-1): contem apenas o icone de slot vazio
  -- + padding transparente. Os icones reais de imbuement comecam na 2a linha. Sem
  -- este +fpr o iconid 1 (Strike) caia exatamente no slot vazio ("imagem nao aparece"
  -- no imbuement tracker) e todos os demais ficavam deslocados uma linha inteira.
  local adjustedId = id - 1 + fpr
  local row = math.floor(adjustedId / fpr)
