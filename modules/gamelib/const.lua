...
-- Native 15.x engine feature ids. These override the legacy OTCv8 custom tail
-- above so Lua feature toggles match src/client/const.h exactly.
GameLevelU16 = 78
GameSoul = 79
...
-- Legacy OTCv8-only feature names still referenced by older Lua modules.
-- Keep them mapped away from active 15.x engine flags.
GameNewWalking = GameAllowPreWalk
GameNoDebug = 0
GamePacketSizeU32 = 0
GamePacketCompression = 0
GameExtendedOpcode = 0
GameBot = 0
GameBiggerMapCache = 0
GameForceLight = 0
GameBotProtection = 0
GameOldInformationBar = 0
GameHealthInfoBackground = 0
GameWingOffset = 0
GameAuraFrontAndBack = 0
GameQuickLootFlags = GameThingQuickLoot
GameLoadTibiaAssets = GameLoadSprInsteadProtobuf
...
MessageModes.Notification = MessageModes.Attention
MessageModes.BoostedMessage = MessageModes.BoostedCreature
...
ControlButtonNames = {
  ...
  ["button_taskhunting"] = "Task Hunting",
}
...
ControlButtonTooltips = {
  ...
  ["button_minibot"] = "%s mini bot window",
  ...
  ["button_taskhunting"] = "%s Task Board (Bounty / Weekly / Shop)",
}
...
ENumericSoundType = {
  ...
  EVENT = 11,
  UI = 12,
  WHISPER_WITHOUT_OPEN_CHAT = 13,
  CHAT_MESSAGE = 14,
  PARTY = 15,
  VIP_LIST = 16,
  RAID_ANNOUNCEMENT = 17,
  SERVER_MESSAGE = 18,
  SPELL_GENERIC = 19,
}
