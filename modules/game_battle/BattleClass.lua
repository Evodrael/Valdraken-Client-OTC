...
function BattleClass:createButton()
  local battleButton = g_ui.createWidget('BattleButton', self.panel) or g_ui.createWidget('CreatureButton', self.panel)
...
function BattleClass:configure(windowId, window)
  ...
  battlePanel.createButton = function()
    local battleButton = g_ui.createWidget('BattleButton', battlePanel) or g_ui.createWidget('CreatureButton', battlePanel)
    if not battleButton then return end
    UICreatureButton.setup(battleButton)
    battleButton:hide()
    battleButton.onMouseRelease = onBattleButtonMouseRelease
  ...
  UICreatureButtonList.startCreatureRefresh(self.panel)
