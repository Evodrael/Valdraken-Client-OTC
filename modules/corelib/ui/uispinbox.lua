...
function UISpinBox:onSetup()
  g_mouse.bindAutoPress(self:getChildById('up'), function() UISpinBox.up(self) end, 300)
  g_mouse.bindAutoPress(self:getChildById('down'), function() UISpinBox.down(self) end, 300)
end
