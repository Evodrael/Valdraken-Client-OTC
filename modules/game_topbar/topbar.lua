...
local horizontalProgressSize = { width = 857, height = 12 }
local verticalProgressSize = { width = 12, height = 857 }
local horizontalManaShieldSize = { width = 857, height = 6 }
local verticalManaShieldSize = { width = 6, height = 857 }
local horizontalShieldManaSize = { width = 857, height = 5 }
local verticalShieldManaSize = { width = 5, height = 857 }
local verticalWideProgressSize = { width = 25, height = 857 }
...
function refresh(profileChange, skipSetup)
    ...
    onSerenityChange(player, player:isSerene())
...
function onHealthChange(localPlayer, health, maxHealth)
    ...
    local layoutDimensions = {
        compact = verticalSideBar and { width = verticalProgressSize.width, height = verticalProgressSize.height } or { width = horizontalProgressSize.width, height = horizontalProgressSize.height },
        default = verticalSideBar and { width = verticalProgressSize.width, height = verticalProgressSize.height } or { width = horizontalProgressSize.width, height = horizontalProgressSize.height },
        parallel = verticalSideBar and { width = verticalProgressSize.width, height = verticalProgressSize.height } or { width = horizontalProgressSize.width, height = horizontalProgressSize.height },
        large = verticalSideBar and { width = verticalWideProgressSize.width, height = verticalWideProgressSize.height } or { width = horizontalProgressSize.width, height = horizontalProgressSize.height }
    }
...
function onManaShieldChange(localPlayer, mana, maxMana)
    ...
    local shieldActive = localPlayer:useMagicShield() or localPlayer:hasState(PlayerStates.NewMagicShield)
    ...
    local layoutDimensions = {
        compact = verticalSideBar and { width = verticalShieldManaSize.width, height = verticalShieldManaSize.height } or { width = horizontalShieldManaSize.width, height = horizontalShieldManaSize.height },
        sidecompact = verticalSideBar and { width = verticalShieldManaSize.width, height = verticalShieldManaSize.height } or { width = horizontalShieldManaSize.width, height = horizontalShieldManaSize.height },
        default = verticalSideBar and { width = verticalShieldManaSize.width, height = verticalShieldManaSize.height } or { width = horizontalShieldManaSize.width, height = horizontalShieldManaSize.height },
        parallel = verticalSideBar and { width = verticalShieldManaSize.width, height = verticalShieldManaSize.height } or { width = horizontalShieldManaSize.width, height = horizontalShieldManaSize.height },
        large = verticalSideBar and { width = verticalShieldManaSize.width, height = verticalShieldManaSize.height } or { width = horizontalShieldManaSize.width, height = horizontalShieldManaSize.height }
    }
...
function onManaChange(localPlayer, mana, maxMana)
    ...
    local manaPercent = (mana / maxMana) * 100
    local useShield = localPlayer:useMagicShield() or localPlayer:hasState(PlayerStates.NewMagicShield)
    local verticalSideBar = (currentDirection == 'left' or currentDirection == 'right')
    ...
    if useShield then
        ...
        for _, layout in pairs(layoutDimensions) do
            layout[dimensionKey] = verticalSideBar and verticalManaShieldSize.width or horizontalManaShieldSize.height
        end
    end
