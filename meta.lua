...
---@return ThingType[]
function g_things.getMarketThings() end

---@param itemId integer
---@return boolean
function g_things.isMarketTieredItem(itemId) end
...
---@param bonus integer
---@param coresUsed? boolean[]
---@param append? integer
function g_game.codexAction(action, bonus, coresUsed, append) end

---@param bonus integer
function g_game.miniCodexAction(bonus) end
...
---@param mode integer
function UIMinimap:setPartyColorMode(mode) end

---@return integer
function UIMinimap:getPartyColorMode() end
...
---@return string[]
function g_extras.getAll() end

---@param key string
---@return boolean
function g_extras.get(key) end

---@param key string
---@param value boolean
function g_extras.set(key, value) end
...
---@param widget WidgetType | nil
function g_ui.setInputLockWidget(widget) end

---@return WidgetType | nil
function g_ui.getInputLockWidget() end

---@return WidgetType | nil
function g_ui.getCustomInputWidget() end
...
---@param visible boolean
function UIWidget:setImageVisible(visible) end
...
---@return boolean
function UIWidget:isImageVisible() end
